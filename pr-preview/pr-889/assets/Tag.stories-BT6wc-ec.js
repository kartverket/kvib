import{j as r}from"./extends-CwFRzn3r.js";import{r as l}from"./index-BwDkhjyp.js";import{T as s,a as z,b as E}from"./tag-B0Dbxm-Y.js";import{H as g}from"./h-stack-BA5VzuBF.js";const H={title:"Datavisning/Tag",component:s,parameters:{docs:{story:{inline:!0},canvas:{sourceState:"shown"}}},argTypes:{variant:{description:"The variant of the Tag",table:{type:{summary:"subtle | solid | outline"},defaultValue:{summary:"subtle"}},options:["subtle","solid","outline"],control:"radio"},colorScheme:{description:"The visual color appearance of the Tag",table:{type:{summary:"green | blue | red | gray"},defaultValue:{summary:"gray"}},options:["green","blue","red","gray"],control:"radio"},size:{description:"The size of the Tag",table:{type:{summary:"sm | md | lg"},defaultValue:{summary:"md"}},options:["sm","md","lg"],control:{type:"radio"}}}},o={render:a=>r.jsx(s,{...a,children:"Eksempeltag"})},n={render:a=>r.jsx(g,{spacing:4,children:["green","blue","red","gray"].map(e=>l.createElement(s,{...a,key:e,colorScheme:e},e))})},t={args:{variant:"solid",colorScheme:"green"},render:a=>r.jsx(g,{spacing:4,children:["sm","md","lg"].map(e=>l.createElement(s,{...a,size:e,key:e},e))})},i={args:{colorScheme:"blue"},render:a=>r.jsx(g,{spacing:4,children:["subtle","solid","outline"].map(e=>l.createElement(s,{...a,variant:e,key:e},e))})},c={args:{colorScheme:"green",variant:"solid",size:"lg"},render:a=>r.jsxs(s,{...a,children:[r.jsx(z,{children:"Green"}),r.jsx(E,{})]})};var m,d,p;o.parameters={...o.parameters,docs:{...(m=o.parameters)==null?void 0:m.docs,source:{originalSource:`{
