import{j as a}from"./extends-CwFRzn3r.js";import{r as u}from"./index-BwDkhjyp.js";import{D as b,n as m}from"./style-C2qkO5ty.js";import{u as g}from"./use-theme-CeOC8r1f.js";const d=({showOutsideDays:e=!0,...r})=>{const n=h("kvib-datepicker"),o=g(),s=y(n,o.colors[r.colorScheme??o.components.Datepicker.defaultProps.colorScheme]);return a.jsxs("div",{...r.ariaLabel?{"aria-label":r.ariaLabel}:{},children:[a.jsx("style",{children:s}),a.jsx(b,{showOutsideDays:e,classNames:{root:n},locale:m,...r,mode:"range"})]})},y=(e,r)=>`
 .${e} {
