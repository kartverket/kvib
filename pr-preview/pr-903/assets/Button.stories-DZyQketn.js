import{j as e}from"./extends-CwFRzn3r.js";import{S as D}from"./stack-divider-BE2Yhewy.js";import{B as n}from"./Button-CE0-8Nmm.js";import{B as t}from"./ButtonGroup-CPfUJfpb.js";import{V as F}from"./v-stack-D7XFool3.js";const P={title:"Komponenter/Button",component:n,parameters:{docs:{story:{inline:!0},canvas:{sourceState:"hidden"}}},argTypes:{size:{description:"Size of the Button",table:{type:{summary:"xs | sm | md | lg"},defaultValue:{summary:"md"}},options:["xs","sm","md","lg"],control:{type:"radio"}},variant:{description:"The variant of the Button.",table:{type:{summary:"primary | secondary | tertiary | ghost"},defaultValue:{summary:"primary"}},options:["primary","secondary","tertiary","ghost"],control:{type:"radio"}},colorScheme:{description:"The visual color appearance of the component.",table:{type:{summary:"green | blue | gray | red"},defaultValue:{summary:"green"}},options:["green","blue","gray","red"],control:{type:"radio"}},isDisabled:{description:"If true, the button will be disabled.",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}},control:"boolean"},isLoading:{description:"If true, the button will show a spinner.",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}},control:"boolean"},iconFill:{table:{type:{summary:"boolean"}},control:"boolean"},iconAriaIsHidden:{table:{type:{summary:"boolean"}},control:"boolean",defaultValue:{summary:!1}}}},o={args:{children:"Klikk her"},parameters:{docs:{canvas:{sourceState:"shown"}}},render:function(u){return e.jsx(n,{...u,children:u.children})}},i={render:r=>e.jsxs(t,{orientation:"vertical",children:[e.jsx(n,{...r,children:"Nettside"}),e.jsx(n,{colorScheme:"blue",...r,children:"Forvaltning"})]})},a={args:{children:"Klikk her"},render:r=>e.jsxs(t,{justifyContent:"space-between",height:["fit-content","fit-content","28rem"],orientation:"vertical",gap:"1rem",children:[e.jsx(n,{...r,variant:"primary",children:r.children}),e.jsx(n,{...r,variant:"secondary",children:r.children}),e.jsx(n,{...r,variant:"tertiary",children:r.children}),e.jsx(n,{...r,variant:"ghost",children:r.children})]})},s={args:{children:"Klikk her"},render:r=>e.jsxs(t,{children:[e.jsx(n,{...r,isLoading:!0,children:r.children}),e.jsx(n,{...r,isDisabled:!0,children:r.children})]})},c={args:{children:"Klikk her"},render:r=>e.jsxs(t,{children:[e.jsx(n,{...r,leftIcon:"favorite",children:r.children}),e.jsx(n,{...r,rightIcon:"favorite",children:r.children}),e.jsx(n,{...r,iconFill:!0,rightIcon:"favorite",children:r.children})]})},l={args:{children:"Klikk her"},render:r=>e.jsxs(t,{children:[e.jsx(n,{...r,size:"xs",children:r.children}),e.jsx(n,{...r,size:"sm",children:r.children}),e.jsx(n,{...r,size:"md",children:r.children}),e.jsx(n,{...r,size:"lg",children:r.children})]})},d={args:{children:"Klikk her"},render:r=>e.jsxs(F,{divider:e.jsx(D,{borderColor:"gray.200"}),children:[e.jsxs(t,{orientation:"vertical",variant:"secondary",spacing:"4",size:"sm",w:"100%",children:[e.jsx(n,{...r,children:r.children}),e.jsx(n,{...r,children:r.children})]}),e.jsxs(t,{colorScheme:"blue",isAttached:!0,children:[e.jsx(n,{...r,children:r.children}),e.jsx(n,{rightIcon:"add",...r,children:r.children})]})]})};var h,m,p;o.parameters={...o.parameters,docs:{...(h=o.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    children: "Klikk her"
  },
  parameters: {
