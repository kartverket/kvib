...
<Box bg="{colors.gray.50}" />
        `}),e.jsx("br",{}),'Det samme gjelder for alle tokens, der man bytter ut "colors" med token-navnet (f.eks. "spacing", "sizes", osv.).',e.jsx("br",{}),e.jsx("br",{})]})},{title:"objectFit på Image-komponenten",description:e.jsxs(e.Fragment,{children:[e.jsx(t,{children:"objectFit"})," på ",e.jsx(t,{children:"Image"}),"-komponenten har endret standardverdi til ",e.jsx(t,{children:"cover"}),". Ønsker man at bildet ikke skal fylle hele bilderammen kan man bruke ",e.jsx(t,{children:'objectFit="contain"'})," eller"," ",e.jsx(t,{children:'objectFit="fit"'}),"."]})}],H=[{title:"Dot-notasjon for komponentene",description:e.jsxs(e.Fragment,{children:["Man kan nå importere én rot-komponent og få tilgang til alle underkomponentene gjennom dot-notasjon. Dette er standarden i Chakra fra nå, men for å unngå enorme mengder med breaking changes har vi valgt å fortsatt tilby komponentene våre som enkeltstående importer, i tillegg til dot-notasjon. Dette tas i bruk ved å importere"," ",e.jsx(t,{children:"Kvib*"}),"-komponentene, som f.eks. ",e.jsx(t,{children:"KvibAccordion"}),". Dette gir tilgang til underkomponentene gjennom dot-notasjon, som f.eks. ",e.jsx(t,{children:"KvibAccordion.Item"}),"."]})}],w=[{title:"primary",description:e.jsx(e.Fragment,{children:e.jsx(t,{children:"solid"})})},{title:"secondary",description:e.jsx(e.Fragment,{children:e.jsx(t,{children:"outline"})})},{title:"tertiary",description:e.jsx(e.Fragment,{children:e.jsx(t,{children:"plain"})})},{title:"ghost",description:e.jsx(e.Fragment,{children:e.jsx(t,{children:"ghost"})})}],L=()=>e.jsxs(g,{tittel:"Kvib 5",beskrivelse:"Versjon 5 av Kvib bygger på Chakra 3 og har en rekke nyheter med seg. I denne oversikten vil vi fremheve de viktigste endringene og hvordan dette påvirker brukerne av tidligere versjoner av Kvib.",children:[e.jsx(x,{status:"info",size:"lg",children:"Dokumentasjonen vår vil være litt utdatert i en tid fremover etter oppdateringen."}),e.jsx(i,{tittel:"Ny syntaks",children:e.jsx(l,{children:H.sort((r,o)=>r.title>o.title?1:-1).map(r=>e.jsx(n,{tittel:r.title,children:r.description},r.title))})}),e.jsx(a,{as:"h2",children:"Endringer i komponenter"}),e.jsx(u,{}),e.jsx(b,{}),e.jsxs(i,{tittel:"Alert Dialog",children:["Slått sammen med ",e.jsx(t,{children:"Modal"})," i den nye komponenten ",e.jsx(t,{children:"Dialog"}),", hvor man kan sette propen"," ",e.jsx(t,{children:'role="alertdialog"'})," for å få en Alert Dialog som før."]}),e.jsx(f,{}),e.jsx(v,{}),e.jsx(F,{}),e.jsx(S,{}),e.jsx(T,{}),e.jsx(C,{}),e.jsx(y,{}),e.jsx(B,{}),e.jsx(I,{}),e.jsxs(i,{tittel:"Komponenter med nye navn",children:["Flere av komponentene har fått nye navn. Dette byr på breaking changes for de som oppgraderer fra tidligere versjoner av Kvib.",e.jsx(l,{children:A.sort((r,o)=>r.title>o.title?1:-1).map(r=>e.jsx(n,{tittel:r.title,children:r.description},r.title))}),e.jsx("br",{}),e.jsx(a,{as:"h3",fontWeight:700,fontSize:"md",children:"Props med nye navn"}),e.jsx(l,{children:D.sort((r,o)=>r.title>o.title?1:-1).map(r=>e.jsx(n,{tittel:r.title,children:r.description},r.title))})]}),e.jsx(i,{tittel:"Varianter",children:e.jsx(l,{children:w.map(r=>e.jsx(n,{tittel:r.title,children:r.description},r.title))})}),e.jsx(i,{tittel:"Nye komponenter",children:e.jsx(l,{children:M.sort().map(r=>e.jsx(n,{tittel:r},r))})}),e.jsx(i,{tittel:"Fjernede komponenter, hooks og props",children:e.jsx(l,{children:k.sort((r,o)=>r.title>o.title?1:-1).map(r=>e.jsx(n,{tittel:r.title,children:r.description},r.title))})})]});function c(r){return e.jsxs(e.Fragment,{children:[e.jsx(m,{title:"Migrere til Kvib 5"}),`
`,e.jsx(L,{})]})}function Y(r={}){const{wrapper:o}={...h(),...r.components};return o?e.jsx(o,{...r,children:e.jsx(c,{...r})}):c()}export{Y as default};
