import{j as e}from"./index-Bqoz-m_F.js";import{bx as s,by as i,bz as m}from"./index-DuafSpvy.js";const l={title:"Komponenter/Stat",component:s,parameters:{docs:{story:{inline:!0}}},argTypes:{size:{description:"The size of the component",table:{type:{summary:" sm | md | lg"},defaultValue:{summary:"md"}},options:["sm","md","lg"],control:{type:"radio"}}}},t={render:n=>e.jsxs(s,{...n,children:[e.jsx(i,{children:"Utgifter"}),e.jsx(m,{children:"3200kr"})]})};var r,a,o;t.parameters={...t.parameters,docs:{...(r=t.parameters)==null?void 0:r.docs,source:{originalSource:`{
