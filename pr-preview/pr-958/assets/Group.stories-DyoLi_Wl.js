import{j as t}from"./index-Bqoz-m_F.js";import{bG as s,B as o}from"./index-DuafSpvy.js";const i={title:"Komponenter/Layout/Group",component:s,parameters:{docs:{story:{inline:!0}}},argTypes:{attached:{description:"Attach children to each other",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}},control:{type:"boolean"}},grow:{description:"Grow children to fill the container",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}},control:{type:"boolean"}}}},c=`
<Group {...args}>
