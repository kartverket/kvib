import{j as e}from"./index-D6_wGsWO.js";import{useMDXComponents as p}from"./index-BGZZYR5m.js";import"./chunk-NUUEMKO5-95wHxxtw.js";import{ai as c,ae as h}from"./index-AKWWBmGj.js";import{d as j,C as t,v as m,T as d}from"./index-DWzSTc1s.js";import{D as x}from"./Dokumentasjonsside-CeO-pcMn.js";import{T as s,L as l,a as n}from"./Tekstblokk-CPWSdIxs.js";import"./index-C7I6S4tq.js";import"./index-EN4ZLXvn.js";import"./iframe-DsJ3dRD2.js";import"../sb-preview/runtime.js";import"./react-18-BzWPIXJh.js";import"./index-CHGET4sZ.js";import"./index-DrFu-skq.js";const i=r=>e.jsxs(j,{mt:"1.5rem",children:[e.jsx("div",{children:r.beskrivelse}),e.jsx(c,{code:r.kildekode})]});try{i.displayName="Kodeeksempel",i.__docgenInfo={description:"",displayName:"Kodeeksempel",props:{beskrivelse:{defaultValue:null,description:"",name:"beskrivelse",required:!0,type:{name:"ReactNode"}},kildekode:{defaultValue:null,description:"",name:"kildekode",required:!0,type:{name:"string"}}}}}catch{}const g=[{title:"Wrap",description:e.jsxs(e.Fragment,{children:["Er fjernet og tilbys nå gjennom HStack med prop-en ",e.jsx(t,{children:"wrap=wrap"}),"."]})},{title:"forwardRef",description:e.jsxs(e.Fragment,{children:["Er fjernet og erstattet med ",e.jsx(t,{children:"React.forwardRef"}),"."]})},{title:"ControlBox",description:e.jsx(e.Fragment,{children:"Er tatt bort."})},{title:"@chakra-ui/icons",description:e.jsxs(e.Fragment,{children:["Er tatt bort. Chakra anbefaler å heller bruker ",e.jsx(t,{children:"react-icons"}),"eller ",e.jsx(t,{children:"lucide-react"}),"."]})},{title:"AvatarGroup",description:e.jsxs(e.Fragment,{children:["Er tatt bort til fordel for en mer generisk ",e.jsx(t,{children:"Group"}),"."]})},{title:"AvatarBadge",description:e.jsxs(e.Fragment,{children:["Er tatt bort. Anbefaler å bruke ",e.jsx(t,{children:"Float"})," i stedet."]})},{title:"TagLeftIcon og TagRightIcon",description:e.jsxs(e.Fragment,{children:["Er tatt bort til fordel for å heller rendre ikonet direkte i ",e.jsx(t,{children:"Tag"}),"."]})},{title:"focusBorderColor og errorBorderColor",description:e.jsxs(e.Fragment,{children:["Er tatt bort som props. Bruk ",e.jsx(t,{children:"--focus-color"})," og ",e.jsx(t,{children:"--error-color"})," i stedet."]})},{title:"preserveScrollBarGap",description:e.jsx(e.Fragment,{children:"Er tatt bort."})},{title:"allowPinZoom",description:e.jsx(e.Fragment,{children:"Er tatt bort."})},{title:"LinkOverlay sin isExternal-prop",description:e.jsxs(e.Fragment,{children:["Denne er fjernet. Man kan heller inkludere en knapp som en del av div-en som blir overlayet og legge til"," ",e.jsx(t,{children:"external"})," på denne."]})},{title:"align på Text-komponenten",description:e.jsxs(e.Fragment,{children:["Fjernet til fordel for ",e.jsx(t,{children:"textAlign"}),"."]})},{title:"useTheme",description:e.jsxs(e.Fragment,{children:["Er fjernet. Man kan nå hente ut tokens ved å bruke ",e.jsx(t,{children:"useKvibContext"})," og kalle på ",e.jsx(t,{children:"token()"}),".",e.jsx(i,{beskrivelse:"Bruk av tokens tidligere:",kildekode:`
const theme = useTheme()
const largeBreakpoint = theme.breakpoints.lg
`}),e.jsx(i,{beskrivelse:"Nå hentes tokens ut slik:",kildekode:`
...
`})]})}],k=()=>e.jsx(s,{tittel:"Accordion",children:e.jsxs(l,{children:[e.jsxs(n,{tittel:"allowMultiple",children:["Omdøpt til ",e.jsx(t,{children:"multiple"}),"."]}),e.jsxs(n,{tittel:"allowToggle",children:["Omdøpt til ",e.jsx(t,{children:"collapsible"}),"."]}),e.jsxs(n,{tittel:"AccordionButton",children:["Omdøpt til ",e.jsx(t,{children:"AccordionItemTrigger"}),"."]}),e.jsxs(n,{tittel:"AccordionPanel",children:["Omdøpt til ",e.jsx(t,{children:"AccordionItemContent"}),"."]}),e.jsxs(n,{tittel:"AccordionIcon",children:["Omdøpt til ",e.jsx(t,{children:"AccordionItemIndicator"}),"."]})]})}),u=()=>e.jsx(s,{tittel:"Alert",children:e.jsxs(l,{children:[e.jsxs(n,{tittel:"Færre varianter",children:["Variantene ",e.jsx(t,{children:"top-accent"})," og ",e.jsx(t,{children:"left-accent"})," er fjernet. Eneste gyldige varianter er nå"," ",e.jsx(t,{children:"solid"}),", ",e.jsx(t,{children:"subtle"}),", ",e.jsx(t,{children:"outline"})," og ",e.jsx(t,{children:"plain"}),"."]}),e.jsxs(n,{tittel:"AlertIcon",children:["Er fjernet. Standard-ikon settes ut fra status på alerten (infotegn på ",e.jsx(t,{children:"info"}),", ",e.jsx(t,{children:"warning"}),"og ",e.jsx(t,{children:"error"}),", checkmark for ",e.jsx(t,{children:"success"}),"), men kan overstyres gjennom ",e.jsx(t,{children:"icon"}),"-propen på ",e.jsx(t,{children:"Alert"}),"."]})]})}),b=()=>e.jsxs(s,{tittel:"Dialog (tidligere kalt Modal)",children:["AlertDialog og Modal har blitt slått sammen til én komponent som nå heter Dialog. I tillegg barnekomponentene også fått nye navn.",e.jsxs(l,{children:[e.jsxs(n,{tittel:"ModalCloseButton",children:["Omdøpt til ",e.jsx(t,{children:"DialogCloseTrigger"}),"."]}),e.jsxs(n,{tittel:"ModalContent",children:["Omdøpt til ",e.jsx(t,{children:"DialogContent"}),"."]}),e.jsxs(n,{tittel:"ModalHeader",children:["Omdøpt til ",e.jsx(t,{children:"DialogHeader"}),"."]}),e.jsxs(n,{tittel:"ModalFooter",children:["Omdøpt til ",e.jsx(t,{children:"DialogFooter"}),"."]}),e.jsxs(n,{tittel:"ModalOverlay",children:["Omdøpt til ",e.jsx(t,{children:"DialogBackdrop"}),"."]})]})]}),v=()=>e.jsxs(s,{tittel:"Input Group",children:[e.jsxs(l,{children:[e.jsxs(n,{tittel:"InputLeftAddon, InputRightAddon",children:["Er fjernet. Bruk ",e.jsx(t,{children:"InputAddon"}),"-komponenten i stedet."]}),e.jsxs(n,{tittel:"InputLeftElement, InputRightElement",children:["Er fjernet. Bruk propsene ",e.jsx(t,{children:"startElement"})," og ",e.jsx(t,{children:"endElement"})," på ",e.jsx(t,{children:"InputGroup"})," i stedet."]})]}),e.jsx(i,{beskrivelse:e.jsxs(e.Fragment,{children:["Av en eller annen grunn så kan man ikke bruke ",e.jsx(t,{children:"InputGroup"})," når man skal bruke"," ",e.jsx(t,{children:"InputAddon"}),". Her blir man tvunget til å heller bruke ",e.jsx(t,{children:"Group"})," med propen"," ",e.jsx(t,{children:"attached"}),"."]}),kildekode:`
<Group attached>
  <InputAddon>kr</InputAddon>
  <Input placeholder="Beløp" />
</Group>
      `})]}),f=()=>e.jsxs(s,{tittel:"Number Input",children:[e.jsx(i,{beskrivelse:e.jsxs(e.Fragment,{children:["Tidligere kunne man bruke ",e.jsx(t,{children:"NumberInput"})," slik med ",e.jsx(t,{children:"name"})," og ",e.jsx(t,{children:"value"})," som props på ",e.jsx(t,{children:"NumberInputField"}),":"]}),kildekode:`
<NumberInput>
  <NumberInputField name={name} value={name} />
</NumberInput>
      `}),e.jsx(i,{beskrivelse:e.jsxs(e.Fragment,{children:["Nå må man flytte disse propsene til ",e.jsx(t,{children:"NumberInput"}),":"]}),kildekode:`
<NumberInput name={name} value={name}>
  <NumberInputField />
</NumberInput>
      `})]}),S=()=>e.jsxs(s,{tittel:"Show",children:["Tidligere hadde man både ",e.jsx(t,{children:"Show"})," og ",e.jsx(t,{children:"Hide"})," for å vise og skjule innhold. Disse er nå forenklet til én komponent som heter ",e.jsx(t,{children:"Show"}),".",e.jsx(i,{beskrivelse:"Eksempel på bruk",kildekode:`
<Show when={...} fallback={...}>
  <div>Innhold</div>
</Show>
`})]}),F=()=>e.jsxs(s,{tittel:"Steps",children:[e.jsx(t,{children:"Stepper"})," har byttet navn til ",e.jsx(t,{children:"Steps"})," og byr på flere endringer i strukturen for hvordan man bruker denne. Her er det såpass store endringer at vi ikke tilbyr et alias for den gamle skrivemåten siden man uansett må gjøre en del endringer i egen kode for å bruke denne.",e.jsx(i,{beskrivelse:e.jsxs(e.Fragment,{children:["Tidligere har man brukt ",e.jsx(t,{children:"Stepper"})," slik:"]}),kildekode:`
<Stepper index={activeStep}>
  {steps.map((step, index) => (
    ...
    `}),e.jsx(i,{beskrivelse:e.jsxs(e.Fragment,{children:["Nå er stepperne og innholdet i de forskjellige splittet opp, slik at man først lister opp alle stegene i en"," ",e.jsx(t,{children:"StepsList"}),", etterfulgt av ",e.jsx(t,{children:"StepsContent"})," som står for innholdet for hvert steg. Det gjøre på følgende måte:"]}),kildekode:`
...
toast({
  ...
  status: "success",
      ...
      `}),e.jsx(i,{beskrivelse:e.jsxs(e.Fragment,{children:["Man tar i bruk ",e.jsx(t,{children:"Toast"})," ved å importere følgende:"]}),kildekode:`
        import { Toaster, toaster } from "@kvib/react";
      `}),e.jsx(i,{beskrivelse:e.jsxs(e.Fragment,{children:["Nå vil man først rendre ",e.jsx(t,{children:"Toaster"})," i appen slik som dette:"]}),kildekode:`
        <Toaster />
      `}),e.jsx(i,{beskrivelse:e.jsxs(e.Fragment,{children:["Deretter kan man trigge en toast ved å bruke ",e.jsx(t,{children:"toaster.create"})," slik:"]}),kildekode:`
toaster.create({
  title: "Tittel i toast-komponent",
  description: "Beskrivelse",
  type: "success",
})
      `}),e.jsx(i,{beskrivelse:e.jsxs(e.Fragment,{children:["Eksempel med ",e.jsx(t,{children:"action"}),"-knapp:"]}),kildekode:`
toaster.success({
  title: "Tittel i toast-komponent",
  description: "Beskrivelse",
  action: {
