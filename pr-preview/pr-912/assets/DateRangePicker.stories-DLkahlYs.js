import{j as t}from"./jsx-runtime-CQsLhzk5.js";import{D as b,n as g}from"./style-B9SQrwGF.js";import{r as m}from"./index-Wp2u197Z.js";import{c as y}from"./colors-DLx86jGi.js";import"./slider-Bgj0f888.js";const a=({...e})=>{const r=f("kvib-datepicker"),l=y[e.colorPalette??"green"],d=Object.fromEntries(Object.entries(l).map(([s,u])=>[s,u.value])),n=h(r,d);return t.jsxs(t.Fragment,{children:[t.jsx("style",{children:n}),t.jsx(b,{classNames:{root:r},locale:g,captionLayout:e.showDropdownMonthYear?"dropdown":"label",...e,mode:"range"})]})},h=(e,r)=>`
 .${e} {
