import{j as s}from"./jsx-runtime-sfY7k0Xq.js";import{v as re}from"./v4-CQkTLCs1.js";import{D as ne,n as L,i as R,f as N}from"./style-CiF8_und.js";import{r as y}from"./index-CcKhGcwW.js";import{I as K}from"./Input-C8FXr1bD.js";import{u as ie}from"./use-field-context-CcEUgBGI.js";import{P as se,a as de,b as le,e as ce}from"./popover-LD_YmeW8.js";import{G as ue}from"./group-DiEFhqFk.js";import{I as T}from"./input-element-CpSc6Iej.js";import{I as pe}from"./IconButton-D2BQOENr.js";import{p as me}from"./parse-BEM0nVXK.js";import{c as fe}from"./colors-DLx86jGi.js";const E=({onChange:e,useNative:a=!1,...t})=>{const o=ye(t),r=be(t),n=t.defaultSelected?v(t.defaultSelected):void 0;return(typeof window=="object"?window.innerWidth<480:!1)||a?s.jsx(K,{type:"date",defaultValue:n,...o,...r,onChange:e}):s.jsx(he,{...t,...r,onChange:e})},he=({onChange:e,defaultSelected:a,defaultMonth:t,fromDate:o,toDate:r,showDropdownMonthYear:n,disableNavigation:u,showOutsideDays:l,showWeekNumber:c,disabledDays:f,colorPalette:p,disabled:_=!1,invalid:x=!1,required:w=!1,...m})=>{const b=ve("kvib-datepicker"),G=fe[p??"green"],H=Object.fromEntries(Object.entries(G).map(([i,d])=>[i,d.value])),J=ge(b,H),h=ie(),Q=(h==null?void 0:h.disabled)||!1,X=(h==null?void 0:h.required)||!1,Z=_||Q,I=w||X,[j,S]=y.useState(!1),[k,D]=y.useState(a??void 0),[C,M]=y.useState(t),[P,O]=y.useState(k?v(k):""),ee=i=>{e==null||e(i),O(i.target.value);const d=q(i.target.value);d&&R(d)?(M(d),D(d)):D(void 0)},te=()=>{const i=q(P);let d="";i&&R(i)&&(d=N(i,"dd.MM.yyyy"));const oe={target:{value:d}};e==null||e(oe),O(d)},ae=i=>{const d={target:{value:i?N(i,"dd.MM.yyyy"):""}};e==null||e(d),i?(D(i),M(i),O(v(i)),S(!1)):(O(""),D(void 0))};return s.jsxs(se,{positioning:{placement:"bottom",offset:{mainAxis:0,crossAxis:-15}},open:j,onOpenChange:i=>S(i.open),children:[s.jsx(_e,{css:{"& > div[data-between]":{paddingInline:"0 !important"}},endElement:s.jsx(de,{css:{"&:hover":{background:"none",color:"colorPalette.400"}},asChild:!0,children:s.jsx(pe,{icon:"calendar_today",colorPalette:p,size:m.size,"aria-label":"open datepicker",onClick:()=>S(!j),variant:"plain"})}),children:s.jsx(K,{value:P,disabled:Z,required:I,onChange:ee,onBlur:te,...m})}),s.jsx(le,{children:s.jsxs(ce,{children:[s.jsx("style",{children:J}),s.jsx(ne,{onSelect:ae,mode:"single",month:C,onMonthChange:M,selected:k,classNames:{root:b},locale:L,showOutsideDays:l,showWeekNumber:c,disableNavigation:u,defaultMonth:t,captionLayout:n?"dropdown":"label",startMonth:o,endMonth:r,required:I,...o&&{disabled:{before:o}},...r&&{disabled:{after:r}},...f&&{disabled:f}})]})})]})},q=e=>{try{const a=["dd.MM.yy","dd.MM.yyyy","dd/MM/yy","dd/MM/yyyy","dd-MM-yy","dd-MM-yyyy"];for(const t of a){const o=me(e,t,new Date,{locale:L});if(!isNaN(o.getTime()))return o}throw new Error("Ugyldig datoformat")}catch{return}};function ye(e){const{defaultSelected:a,defaultMonth:t,fromDate:o,toDate:r,showDropdownMonthYear:n,disableNavigation:u,showOutsideDays:l,showWeekNumber:c,disabledDays:f,...p}=e;return p}function v(e){let a;if(typeof e=="number")a=new Date(e);else if(e instanceof Date)a=e;else if(typeof e=="string"){if(a=new Date(e),isNaN(a.getTime()))throw new Error("Invalid date format.")}else throw new Error("Invalid date format.");const t=a.getFullYear().toString().padStart(4,"0"),o=(a.getMonth()+1).toString().padStart(2,"0");return`${a.getDate().toString().padStart(2,"0")}.${o}.${t}`}const be=e=>{const a=e.fromDate?v(e.fromDate):void 0,t=e.toDate?v(e.toDate):void 0;return{min:a,max:t}},ge=(e,a)=>`
 .${e} {
