import{j as i}from"./jsx-runtime-CQsLhzk5.js";import"./slider-Bgj0f888.js";import{D as re,n as L,i as R,f as N}from"./style-B9SQrwGF.js";import{r as y}from"./index-Wp2u197Z.js";import{c as ne}from"./colors-DLx86jGi.js";import{I as K}from"./Input-B0y1fppS.js";import{u as se}from"./use-field-context-B2lpNrC2.js";import{P as ie,a as le,b as de,e as ce}from"./popover-xoo7BU0Z.js";import{G as ue}from"./group-rOysWJ1R.js";import{I as T}from"./input-element-CR-bCIiX.js";import{I as pe}from"./IconButton-BP4NnPCo.js";import{p as me}from"./parse-B55RHAPX.js";import{v as he}from"./v4-CQkTLCs1.js";const E=({onChange:e,useNative:a=!1,...t})=>{const o=ye(t),r=be(t),n=t.defaultSelected?v(t.defaultSelected):void 0;return(typeof window=="object"?window.innerWidth<480:!1)||a?i.jsx(K,{type:"date",defaultValue:n,...o,...r,onChange:e}):i.jsx(fe,{...t,...r,onChange:e})},fe=({onChange:e,defaultSelected:a,defaultMonth:t,fromDate:o,toDate:r,showDropdownMonthYear:n,disableNavigation:u,showOutsideDays:d,showWeekNumber:c,disabledDays:h,colorPalette:p,disabled:_=!1,invalid:x=!1,required:w=!1,...m})=>{const b=ve("kvib-datepicker"),G=ne[p??"green"],H=Object.fromEntries(Object.entries(G).map(([s,l])=>[s,l.value])),J=ge(b,H),f=se(),Q=(f==null?void 0:f.disabled)||!1,X=(f==null?void 0:f.required)||!1,Z=_||Q,I=w||X,[j,S]=y.useState(!1),[k,D]=y.useState(a??void 0),[C,M]=y.useState(t),[P,O]=y.useState(k?v(k):""),ee=s=>{e==null||e(s),O(s.target.value);const l=q(s.target.value);l&&R(l)?(M(l),D(l)):D(void 0)},te=()=>{const s=q(P);let l="";s&&R(s)&&(l=N(s,"dd.MM.yyyy"));const oe={target:{value:l}};e==null||e(oe),O(l)},ae=s=>{const l={target:{value:s?N(s,"dd.MM.yyyy"):""}};e==null||e(l),s?(D(s),M(s),O(v(s)),S(!1)):(O(""),D(void 0))};return i.jsxs(ie,{positioning:{placement:"bottom",offset:{mainAxis:0,crossAxis:-15}},open:j,onOpenChange:s=>S(s.open),children:[i.jsx(_e,{css:{"& > div[data-between]":{paddingInline:"0 !important"}},endElement:i.jsx(le,{css:{"&:hover":{background:"none",color:"colorPalette.400"}},asChild:!0,children:i.jsx(pe,{icon:"calendar_today",colorPalette:p,size:m.size,"aria-label":"open datepicker",onClick:()=>S(!j),variant:"plain"})}),children:i.jsx(K,{value:P,disabled:Z,required:I,onChange:ee,onBlur:te,...m})}),i.jsx(de,{children:i.jsxs(ce,{children:[i.jsx("style",{children:J}),i.jsx(re,{onSelect:ae,mode:"single",month:C,onMonthChange:M,selected:k,classNames:{root:b},locale:L,showOutsideDays:d,showWeekNumber:c,disableNavigation:u,defaultMonth:t,captionLayout:n?"dropdown":"label",startMonth:o,endMonth:r,required:I,...o&&{disabled:{before:o}},...r&&{disabled:{after:r}},...h&&{disabled:h}})]})})]})},q=e=>{try{const a=["dd.MM.yy","dd.MM.yyyy","dd/MM/yy","dd/MM/yyyy","dd-MM-yy","dd-MM-yyyy"];for(const t of a){const o=me(e,t,new Date,{locale:L});if(!isNaN(o.getTime()))return o}throw new Error("Ugyldig datoformat")}catch{return}};function ye(e){const{defaultSelected:a,defaultMonth:t,fromDate:o,toDate:r,showDropdownMonthYear:n,disableNavigation:u,showOutsideDays:d,showWeekNumber:c,disabledDays:h,...p}=e;return p}function v(e){let a;if(typeof e=="number")a=new Date(e);else if(e instanceof Date)a=e;else if(typeof e=="string"){if(a=new Date(e),isNaN(a.getTime()))throw new Error("Invalid date format.")}else throw new Error("Invalid date format.");const t=a.getFullYear().toString().padStart(4,"0"),o=(a.getMonth()+1).toString().padStart(2,"0");return`${a.getDate().toString().padStart(2,"0")}.${o}.${t}`}const be=e=>{const a=e.fromDate?v(e.fromDate):void 0,t=e.toDate?v(e.toDate):void 0;return{min:a,max:t}},ge=(e,a)=>`
 .${e} {
