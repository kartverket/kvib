...
<DocsStory
  ...
  description={
    <Text>
      ...
      <Code>isRequired</Code>. Slik vil det også være enkelt å legge til en label. Dersom Select ikke brukes i form må en
      <Code>aria-label</Code> legges til.
    </Text>
  }
...
Select skal alltid ha en label. Dersom Select ikke brukes i form må en `aria-label` legges til for å tilfredsstille tilgjengelighetskrav.
