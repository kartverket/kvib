...
Bruk forskjellige på knappene dersom handlingene har motsatt handlinger. For eksempel kan "Lagre" være <Code>primary</Code>, mens "Slett" er <Code>secondary</Code>.
