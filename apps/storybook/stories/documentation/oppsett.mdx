...
<KvibProvider>
  <Alert status="warning">
    <AlertIcon />
    <AlertDescription>Avklar med designer før du lager egen styling.</AlertDescription>
  </Alert>
</KvibProvider>
<br />
<KvibProvider>
  <Alert status="info">
    <AlertIcon />
    <AlertDescription>
      I utgangspunktet skal man benytte komponentene fra Kartverkets designbibliotek med stylingen som er der. Er det
      funksjoner og design du synes mangler i dagens bibliotek, ønsker vi at du bidrar med dette til biblioteket
      istedenfor å overskrive stylingen i eget prosjekt- da kan fler enn deg ta det i bruk! Se [dokumentasjonen for
      hvordan bidra til designsystemet](/?path=/docs/bidra--docs) for guidelines. Dersom det likevel er nødvendig å
