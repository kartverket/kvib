...
import { Alert, AlertIcon, AlertTitle, AlertDescription, Button } from "@kvib/react";
...
I utgangspunktet skal man benytte komponentene fra Kartverkets designbibliotek med stylingen som er der.
Er det funksjoner og design du synes mangler i dagens bibliotek, ønsker vi at du bidrar med dette til biblioteket istedenfor å overskrive stylingen i eget prosjekt- da kan fler enn deg ta det i bruk! Se [dokumentasjonen for hvordan bidra til designsystemet](/?path=/docs/bidra--docs) for guidelines.
Dersom det likevel er nødvendig å gjøre egne tilpassninger av stylingen til eget prosjekt, kan dette gjøres med inline styling eller styled-components.

**_OBS!_** Avklar med designer dersom dette skal gjøres.
