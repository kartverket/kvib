...
- Lag en liten oversikt for hva komponenten er **Egnet/Uegnet** til.
- Legg til Feedback komponent fra apps/storybook/stories/templates
- Lag kategoriene **Options, Tilgjengelighet, props, Kjente feil**. Bruk DocsHeading, DocsAnatomy, DocsContainer og DocsStory
fra samme fil. Props skal være beskrevet på engelsk.


- Sett inn den storyen som er default ( Her; Link), og sett inn controll-tabellen til denne storyen:
...
7.  Dersom det er noen kjente feil ved komponenten, eksempelvis med a11y-tester, lag et avsnitt nederst i .mdx-filen slik som dette:
