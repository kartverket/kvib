...
- `title` setter filstrukturen på selve [dokumentasjonssiden til Designbiblioteket](https://kartverket.github.io/kvib). (Putt to stjerner bak navnet på komponenten dersom den er endret)
