...
1. **Skjermleser**:Test hvordan komponenten oppfører seg med skjermleser, eksempelvis NVDA. Det er særlig viktig at tab-navigering fungerer korrekt.
