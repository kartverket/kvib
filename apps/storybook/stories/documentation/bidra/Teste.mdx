...
<KvibProvider>
  <Alert status="info">
    ...
    på hvordan konfigurere a11y](https://storybook.js.org/docs/react/writing-tests/accessibility-testing#configure).
  </Alert>
</KvibProvider>
...
1. Lag en ny tag i git (Trenger bare å bli gjort første gang): `git tag -a chromatic -m "Build with Chromatic"`

2. Add og commit endringer.

3. Push endringer med tag: `git push origin <branch_name> chromatic`.
