...
<KvibProvider>
    <Alert status="info">
        <AlertIcon/>
        _required_ props er ikke det samme som å sette default. Eksempelvis colorScheme er ikke required fordi man
        ønsker ikke
        at brukeren må sette colorScheme dersom hen vil ha default-verdien. Hvordan sette default-verdi kommer i senere
        steg
        i denne guiden.
    </Alert>
</KvibProvider>
...
<KvibProvider>
    <Alert status="info">
        <AlertIcon/>
        Under [“Style komponenten”](/docs/bidra--docs#style-komponenten-) nevnes defaultProps som en del av .ts-filen.
        Default
