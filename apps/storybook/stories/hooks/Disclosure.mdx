    ...
    <Table>
        ...
        <Tbody>
            ...
            <Tr>
                ...
                <Td><code></code></Td>
                <Td>Callback-funksjon for å sette en falsk verdi for **isOpen**-parameteren.</Td>
            </Tr>
            <Tr>
                <Td><code>onOpen</code></Td>
                <Td><code>function</code></Td>
                <Td><code></code></Td>
                <Td>Callback-funksjon for å sette en sann verdi for **isOpen**-parameteren.</Td>
            </Tr>
            <Tr>
    ...
    <Table>
        ...
        <Tbody>
            ...
            <Tr>
                ...
                <Td><code>function</code></Td>
                <Td>Funksjon for å sette en falsk verdi for isOpen-parameteren.</Td>
            </Tr>
            <Tr>
                <Td><code>onOpen (Optional)</code></Td>
                <Td><code>function</code></Td>
                <Td>Funksjon for å sette en sann verdi for isOpen-parameteren.</Td>
            </Tr>
            <Tr>
