import { Flex, mapColors, mapColorsRGBA, Stack, Text } from "@kvib/react";
import { Meta } from "@storybook/addon-docs";
import { ColorPalettes, ExampleBox } from "./ColorPalettes";

<Meta title="Komponenter/Tokens/Farger til kart" />
...
```jsx
import { mapColors, mapColorsRGBA } from "@kvib/react";
```
