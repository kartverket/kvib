...
Vi har utviklet en rekke kartfarger for å gjøre det enklere for deg å lage konsistente og estetisk tiltalende kartløsninger i vårt designsystem. Disse fargene er nøye testet og tilpasset for å fungere godt med ulike bakgrunnskart. Fargekoder til kart er definert i variablene `mapColors` og `mapColorsRGBA`. Disse kan importeres direkte. Fargepalettene brukes ved å referere til fargevariablene i mapColors eller mapColorsRGBA.
...
** Primærfarge (Hovedkartfarge): Fargekode #F15D4E (Red)
** Sekundærfarge (Sekundærkartfarge): Fargekode #E56D31 (Brown)
