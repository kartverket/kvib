  ...
  designsystemSidebar: [
    ...
    },
    {
      ...
      link: {
        ...
        title: "Design tokens",
        description:
          "Her er oversikt over hvilke type design tokens som er tilgjengelige i KVIB. Design tokens er grunnleggende verdier som brukes for den visuelle delen av designsystemet,for eksempel farger,spacing, font og animasjoner." +
    ...
    },
    {
      ...
      link: {
        ...
        title: "Komponenter",
        description:
          "Her er en oversikt over utvalget av komponenter i KVIB." +
      ...
      items: [
        ...
        "designsystems/Komponenter/detailsID",
        {
          ...
          link: {
            ...
            title: "Knapper",
            description:
              "Her er en oversikt over utvalget av Knapper i KVIB." +
              " Disse er blant annet bygget opp ved bruk av desing tokens fra KVIB, eksempelvis farger og typografi. I dokumentasjonen følger beskrivelse av komponenten og bruksområde, sammen med kodeeksempler.",
            slug: "designsystems/Komponenter/Knapper",
          },
          items: [
            "designsystems/Komponenter/Knapper/standardKnappID",
