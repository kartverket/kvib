...
Dersom selve dokumentasjonssiden skal ha styles etter egne preferansen, skal CSS-filene for dette legges under _src/docusaurus_custom_css_. Husk å lenke filene i _custom.css_:
```markdown
@import './filnavn.css';
```
...
Ved opprettelse av ny _.mdx_ fil skal filens id, title, description, slug, displayed_sidebar og sidebar_position ligge øverst i filen. Se eksempel for radioknapp under:
```markdown
---
