...
Per i dag støtter ikke .mdx <script\>-taggen. Av den grunn finnes det en mappe for HTML-filer under src/html, slik at komponentene kan demonstreres. Se [Innhold](#innhold) for hvordan komponenter som krever Javascript kan dokumenteres.
...
![github actions](/img/image_docs/github_actions.PNG)
