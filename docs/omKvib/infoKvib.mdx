...
KVIB består av npm-biblioteket KVIB-CSS, som inneholder felles CSS for Kartkverkets applikasjoner.
Denne nettsiden inneholder dokumentasjon av de felles designprinsippene og bruken av stilene i KVIB-CSS. Designet til komponentene har utgangspunkt i designet som ligger på figma-KVIB. Innholdet der er laget og godkjent av en designer.
