...
### npm
1. Opprett en .npmrc fil i prosjektmappen og legg til følgende:

```
@kartverket:registry=https://npm.pkg.github.com
```

2. I prosjektmappen som inneholder .npmrc filen, logg på npm med GitHub brukernavn og PAT ved å bruke følgende kommando:
