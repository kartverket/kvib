...
Et eksempel som demonstrerer oppførselen til en listevisning og hvordan denne kan se ut finnes <a href="/html/table.html" target="_blank" rel="noopener noreferrer" download="table.html">her</a>. Ettersom "Slett alle"-funksjonen krever Javascript, kan denne ikke vises på denne siden. Se ellers standard malen under.
