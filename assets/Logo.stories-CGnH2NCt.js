import{j as e}from"./index-D6_wGsWO.js";import{be as o,d as u}from"./index-hsVzZxqS.js";const v={title:"Komponenter/Logo",component:o,parameters:{docs:{story:{inline:!0},canvas:{sourceState:"shown"}}},argTypes:{label:{table:{type:{summary:"string"}},control:"text"},variant:{table:{type:{summary:"vertical | horizontal"},defaultValue:{summary:"vertical"}},options:["vertical","horizontal"],control:{type:"radio"}},size:{table:{type:{summary:"number"}},control:"number"}}},a={args:{label:"Logo"},render:r=>e.jsx(o,{...r})},s={args:{label:"Logo",variant:"horizontal"},render:r=>e.jsx(o,{...r})},t={args:{label:"Logo",variant:"horizontal"},render:r=>e.jsxs(u,{children:[e.jsx(o,{...r,size:100}),e.jsx(o,{...r,size:200}),e.jsx(o,{...r,size:300})]})};var n,i,l;a.parameters={...a.parameters,docs:{...(n=a.parameters)==null?void 0:n.docs,source:{originalSource:`{
  args: {
    label: "Logo"
  },
