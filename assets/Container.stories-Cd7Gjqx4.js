import{j as s}from"./jsx-runtime-DgHZ7iq2.js";import{C as o}from"./container-CPeF9f1M.js";const i={title:"Komponenter/Layout/Container",component:o,parameters:{docs:{story:{inline:!0}}},argTypes:{centerContent:{description:"Center content inside container",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}},control:{type:"boolean"}},fluid:{description:"Use full width container",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}},control:{type:"boolean"}},p:{table:{disable:!0}},bg:{table:{disable:!0}}}},c=`
<Container>
  ...
</Container>
