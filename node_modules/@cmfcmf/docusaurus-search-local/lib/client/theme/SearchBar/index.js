...
const SearchBar = () => {
    ...
    const { titleBoost, contentBoost, tagsBoost, parentCategoriesBoost, indexDocSidebarParentCategories, maxSearchResults, } = usePluginData("@cmfcmf/docusaurus-search-local");
                ...
                return [
                    {
                        ...
                        templates: {
                            ...
                            item({ item }) {
                                ...
                                React.createElement("a", { href: url, className: "aa-ItemLink", onClick: (e) => {
                                        ...
                                        history.push(url, {
                                            cmfcmfhighlight: {
                                                terms: item.terms,
                                                isDocsOrBlog: item.document.type === "docs" ||
                            ...
                            noResults() {
                                return (React.createElement("div", { className: "aa-ItemContent" },
                                    React.createElement("div", { className: "aa-ItemContentBody" }, SEARCH_INDEX_AVAILABLE
                                        ? translate({
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement("div", { className: "dsla-search-wrapper" },
            React.createElement("div", { className: "dsla-search-field", ref: autocompleteRef, "data-tags": tags.join(",") }))));
};
